...
> reproduction, distribution, or use without written permission is
> prohibited.
>
...
- Investor or partner? See the [Program Roadmap](research/roadmap.md) for
  the study sequence, phase structure, and consortium participation model.
...
Longer-form, non-technical pieces on the ideas behind the program:

- [Two Minds](essays/two_minds.md) — cognitive science and AI, and what each field has learned about thinking
- [The Machines We Made in Our Own Image](essays/trajectory_of_ai.md) — where AI came from, where it stands, and what's coming
